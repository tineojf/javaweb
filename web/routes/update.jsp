...
<html lang="es">
    ...
    <body>
        <%
            AsociadoModel associate = (AsociadoModel) request.getAttribute("associate");
        %>
        <script>
            ...
            <div class="dash-content">
                <div class="activity mr">
                    <div class="title">
                        ...
                        <span class="text">Update Associate</span>
                    </div>
                </div>

                <div class="content ml">
                    <form action="<%= svupdatePath%>" method="POST">
                        <div class="form-columns">
                            <input
                                type="hidden"
                                name="id"
                                required
                                value ="<%= associate.getCodigo()%>"
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="form-input"
                                    value ="<%= associate.getNivelEstudio()%>"
                                    />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="0"
                                    class="form-input"
                                    value ="<%= associate.getNumeroHijos()%>"
                                    />
                            </div>
